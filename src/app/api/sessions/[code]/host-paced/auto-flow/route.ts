...
import { setHostPacedAutoFlowPaused } from "@/lib/host-paced";
...
export async function POST(request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    const result = await setHostPacedAutoFlowPaused(code, body.paused === true);
    ...
    console.error("Host-paced auto-flow update failed", error instanceof Error ? error.message : "Unknown error");
