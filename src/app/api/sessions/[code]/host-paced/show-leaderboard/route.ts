...
import { setHostPacedPhase } from "@/lib/host-paced";
...
export async function POST(_request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    const result = await setHostPacedPhase(code, "LEADERBOARD");
    ...
    console.error("Host-paced leaderboard failed", error instanceof Error ? error.message : "Unknown error");
