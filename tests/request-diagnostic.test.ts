...
test('administrative diagnostics retain machine codes but suppress SQL, secrets and arbitrary values',()=>{
  ...
  const error=Object.assign(new Error(secret),{name:'PrismaClientKnownRequestError',code:'P2010',meta:{driverAdapterError:{cause:{originalCode:'1267',originalMessage:'Illegal mix of collations '+secret}}}});
